...
Project_J는 Unreal Engine(C++) 기반으로 작성된 게임 프로젝트입니다. 이 저장소의 Source 폴더에는 Gameplay Tag 정의, AI(Behavior Tree) 노드, 전투 관련 컴포넌트/인터페이스, 애니메이션 몽타주 데이터 등 게임 플레이 핵심 로직을 C++로 구현한 코드가 들어 있습니다
